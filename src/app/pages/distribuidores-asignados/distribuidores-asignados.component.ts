...
@Component({
  selector: 'app-distribuidores-asignados', // El selector CSS que representa este componente en la plantilla HTML.
  templateUrl: './distribuidores-asignados.component.html', // La ubicación de la plantilla HTML del componente.
  styleUrl: './distribuidores-asignados.component.scss' // La ubicación de los estilos específicos del componente.
})
export class DistribuidoresAsignadosComponent {
  ...
  constructor(private sanitizer: DomSanitizer) { // Inyecta DomSanitizer en el componente.
    const url = "https://socialmedia.sicopweb.net/?tab=distribuidores"; // La URL que se quiere incrustar de manera segura.
